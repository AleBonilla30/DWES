<?php
//variables configurables por el administrador de la app
...
function conectaDb() {
    ...
    try {
        ...
        echo "<p class='aviso'>Error: No se puede conectarse con la base de datos. {$e->getMessage()}</p>\n";
        exit;
    } finally{
...
//funcion borrado y creacion de la base de  datos
...
function borrarTodo(){
    ...
    if (!$pdo->query($consulta)) {
        ...
        print "<p>Base de datos borrada correctamente (si existia).</p>";
    }
    print "\n";

    $consulta = "CREATE DATABASE $cfg[mysqlDatabase] CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci";
