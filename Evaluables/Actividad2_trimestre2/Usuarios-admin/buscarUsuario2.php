...
<body>
    <main class="container-fluid mt-5">
        <div class="container">
            ...
            <h2 class="text-primary">Usuario encontrado</h2>
            <p class="lead">Aquí puedes ver y administrar el usuario registrados.</p>
            </div>
                    ...
                    <tbody>
                        ...
                        // Asegúrate de que ambos campos estén presentes
                            ...
                            if ($correo) {
                                ...
                                $checkSql1 = "SELECT * FROM usuario WHERE correo LIKE '%$correo%'";
                            ...
                            Por favor, proporciona un ID o un CORREO para BUSCAR al usuario.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>';
                        }
                    }
