...
$id_usuario =  mysqli_real_escape_string($conn, trim($_POST['id']));
$sqlBusqueda = "SELECT usuario_id, nombres, correo, clave FROM usuario WHERE usuario_id = '$id_usuario' ";
...
<body>
    <main class="container-fluid">
        <div class="modify-container mt-5">
            <div class="modify-form animate__animated animate__fadeInDown">
            <h1 class="text-center ">Modificar usuario</h1>
            <form action="modificarUsuario3.php" method="post">
                <?php while($row = mysqli_fetch_assoc($result)) { ?>
                <div class="mb-3">
                    <label for="id" class="form-label">ID:</label>
                    <input type="number" class="form-control" name="id" value="<?php echo $row['usuario_id'] ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" name="pass" value="<?php echo $row['clave'] ?>">
                </div>
