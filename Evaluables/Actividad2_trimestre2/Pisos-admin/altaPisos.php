...
<main class="container-fluid mt-2">
        ...
        <div class="contenedorVendedor mt-3">
                    ...
                    <form action="altaPisos.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if (move_uploaded_file($rutaTemporal, $rutaDestino)) {
                            $sql = "INSERT INTO pisos (calle, numero, piso, puerta, cp, metros, zona, precio, imagen, usuario_id, vendido)
                                    VALUES ('$calle', '$numero', '$piso', '$puerta', '$cp', '$metros', '$zona', '$precio', '$rutaDestino','$usuario_id', '$vendido')";
                            ...
                            if (mysqli_query($conn, $sql)) {
                                ...
                                echo '<div class="alert alert-warning alert-dismissible fade show mt-3" role="alert">
                                    Error al registrar el inmueble:'. mysqli_error($conn).
                                    '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>';
                            }        
                        }
